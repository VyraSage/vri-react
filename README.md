...
We provide a sample app to get React working in Vite that you can deploy on App Platform. These steps will get this sample application running for you using App Platform.
...
[![Deploy to DigitalOcean](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/apps/new?repo=https://github.com/digitalocean/sample-vite-react/tree/main)
...
1. Edit `src/App.jxs` and replace "Welcome to Your New Vite + React App" with a different greeting
